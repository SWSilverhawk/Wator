...
# secondo frammento 
FILE_DA_CONSEGNARE2=Makefile wator.c gestore_main.c gestore_argomenti.c gestore_segnali.c dispatcher.c workers.c collector.c visualizer.c variabili.c wator.h funzioni.h watorscript

# terzo frammento 
FILE_DA_CONSEGNARE3=Makefile Relazione.pdf gruppo.txt wator.c gestore_main.c gestore_argomenti.c gestore_segnali.c dispatcher.c workers.c collector.c visualizer.c variabili.c wator.h funzioni.h watorscript
...
objects1 = wator.o dispatcher.o workers.o collector.o gestore_argomenti.o gestore_segnali.o variabili.o
...
wator: gestore_main.c lib
	$(CC) $(CFLAGS) $< -o wator $(LIBS) -lWator -pthread

visualizer: visualizer.c lib
	$(CC) $(CFLAGS) $< -o visualizer $(LIBS) -lWator -pthread

# make rule per gli altri .o del secondo/terzo frammento (***DA COMPLETARE***)

dispatcher.o: dispatcher.c wator.h funzioni.h
	$(CC) $(CFLAGS) $< -pthread -c

workers.o: workers.c wator.h funzioni.h
	$(CC) $(CFLAGS) $< -pthread -c

collector.o: collector.c wator.h funzioni.h
	$(CC) $(CFLAGS) $< -pthread -c

gestore_argomenti.o: gestore_argomenti.c wator.h funzioni.h
	$(CC) $(CFLAGS) $< -pthread -c

gestore_segnali.o: gestore_segnali.c wator.h funzioni.h
	$(CC) $(CFLAGS) $< -pthread -c

wator.o: wator.c wator.h
	$(CC) $(CFLAGS) $< -pthread -c

variabili.o: variabili.c wator.h
	$(CC) $(CFLAGS) $< -pthread -c
